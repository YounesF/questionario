        ...
        <script>
            ...
            */
            ...
            $('form').on('click', '#creaDomandaAperta' ,function() {
                $('form').html('<span> Domanda numero <span id="numeroDomanda">1</span>:</span><input type="button" id="creaDomandaChiusa" value="crea una domanda chiusa"><br><input type="text" id="testoDomanda" placeholder="Testo Domanda"><br>\n\
                <input type="button" id="aggiungiRisposta" value="aggiungi risposta"><br>\n\
            ...
            $('form').on('click', '#creaDomandaChiusa' ,function() {
                $('form').html('<span> Domanda numero <span id="numeroDomanda">1</span>:</span><input type="button" id="creaDomandaAperta" value="crea una domanda aperta"><br>\n\
